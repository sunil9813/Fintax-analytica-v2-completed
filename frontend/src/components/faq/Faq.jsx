  ...
  return (
    <>
      <section className='faq'>
        {faqs.map((list, i) => (
          <div className=' bg-orange-100 rounded-md mb-8' key={i}>
            <div className='title flex justify-between items-center px-5 py-2'>
              ...
              {open === i ? (
                ...
                <button
                  onClick={() => toggle(i)}
                  className='flex justify-center items-center text-white shadow-lg bg-yellow w-12 h-12 rounded-md transition-all ease-in-out hover:rotate-90 hover:bg-white hover:text-indigo-500'
                >
                  <HiOutlineArrowNarrowRight />
                </button>
              )}
            ...
            <div
              className={open === i ? "details px-7 pb-5 visible" : "hidden"}
            >
