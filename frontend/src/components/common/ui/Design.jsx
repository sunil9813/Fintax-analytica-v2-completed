...
export const Card = ({ children }) => {
  return <div className='bg-white p-8 rounded-lg shadow-md'>{children}</div>
}
export const Title = ({ children }) => {
  return (
    <h1 className='text-xl font-semibold capitalize text-secondary mb-5'>
      {children}
    </h1>
  )
}
...
export const Border = ({ children }) => {
  return (
    <div className='p-5 border border-gray-200 rounded-lg mb-5'>{children}</div>
  )
}
